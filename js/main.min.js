!function (e) {
    ...
    var o = n(1), c = a(o), i = n(2), r = a(i), u = n(3), l = a(u), s = n(4), f = a(s), d = n(5), m = a(d), _ = n(6),
        v = a(_);
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), t["default"] = function () {
        $(".team-acco__trigger").on("click", function (e) {
            e.preventDefault();
            var t = $(this), n = t.closest(".team-acco__item"), a = t.closest(".team-acco"),
                o = a.find(".team-acco__item"), c = n.find(".team-acco__content"), i = a.find(".team-acco__content");
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), t["default"] = function () {
        $(".menu-acco__trigger").on("click", function (e) {
            e.preventDefault();
            var t = $(this), n = t.closest(".menu-acco"), a = t.closest(".menu-acco__item"),
                o = n.find(".menu-acco__item"), c = o.filter(".active"), i = a.find(".menu-acco__content"),
                r = c.find(".menu-acco__content");
            a.hasClass("active") ? (a.removeClass("active"), i.animate({width: "0px"})) : (o.removeClass("active"), a.addClass("active"), r.animate({width: "0px"}), i.animate({width: "550px"}))
        }), $(document).on("click", function (e) {
            var t = $(e.target);
            t.closest(".menu-acco").length || ($(".menu-acco__content").animate({width: "0px"}), $(".menu-acco__item").removeClass("active"))
        })
    }
}, function (e, t, n) {
    "use strict";
    Object.defineProperty(t, "__esModule", {value: !0}), t["default"] = function () {
        function e() {
            t = new ymaps.Map("map", {center: [59.93916998692174, 30.309015096732622], zoom: 11, controls: []});
            for (var e = [[59.94554327989287, 30.38935262114668], [59.91142323563909, 30.50024587065841], [59.88693161784606, 30.319658102103713], [59.97033574821672, 30.315194906302924]], n = new ymaps.GeoObjectCollection({}, {
                draggable: !1,
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), t["default"] = function () {
        ...
        var t = $("#hamburger-menu"), n = $(".nav__item", t), a = 0;
        $(".hamburger-menu-link").on("click", function (n) {
            n.preventDefault(), t.addClass("hamburger-menu_visible").animate({opacity: "1"}, 300, function () {
                e()
